...
- [ ] Extend manual-import extraction for framed or script-only career portals such as branded iCIMS pages, and distinguish an embedded-content or anti-bot access challenge from a posting that simply lacks structured data while preserving manual field entry as the fallback.
